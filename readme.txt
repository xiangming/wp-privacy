...
= 1.5 =
New: The new version allows you to set and customize the title tag for your login page. Also, you can now choose to discourage search engines from indexing your login page